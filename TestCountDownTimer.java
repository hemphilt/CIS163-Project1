...
public class TestCountDownTimer {
	...
	@Test(expected = IllegalArgumentException.class)
	public void testConstructor3ParametersLargeHour() {
	...
	@Test(expected = IllegalArgumentException.class)
	public void testConstructor3ParamatersLargeMinute() {
...
//	}
	...
	@Test(expected = IllegalArgumentException.class)
	public void testConstructorString3ParametersLargeHour() {
		new CountDownTimer("30:2:3");
	}

	@Test(expected = IllegalArgumentException.class)
	public void testConstructorString3ParametersLargeMinute() {
		new CountDownTimer("1:80:3");
	}

	@Test(expected = IllegalArgumentException.class)
	public void testConstructorString3ParametersLargeSecond() {
		new CountDownTimer("1:2:80");
	}

	@Test(expected = IllegalArgumentException.class)
	public void testConstructorString3ParametersNegHour() {
		new CountDownTimer("-30:2:3");
	}

	@Test(expected = IllegalArgumentException.class)
	public void testConstructorString3ParametersNegMinute() {
		new CountDownTimer("1:-80:3");
	}

	@Test(expected = IllegalArgumentException.class)
	public void testConstructorString3ParametersNegSecond() {
		new CountDownTimer("1:2:-80");
	}

	@Test(expected = IllegalArgumentException.class)
	public void testConstructorString3ParametersAlpha() {
		new CountDownTimer("a:1:2");
	}

	@Test
	public void testConstructorString2Parameters() {
		CountDownTimer s = new CountDownTimer("13:14");
		assertTrue(s.getHours() == 0);
	...
	@Test(expected = IllegalArgumentException.class)
	public void testConstructorString2ParametersLargeMinute() {
		new CountDownTimer("80:3");
	}

	@Test(expected = IllegalArgumentException.class)
	public void testConstructorString2ParametersLargeSecond() {
		new CountDownTimer("2:80");
	}

	@Test(expected = IllegalArgumentException.class)
	public void testConstructorString2ParametersNegMinute() {
		new CountDownTimer("-80:3");
	}

	@Test(expected = IllegalArgumentException.class)
	public void testConstructorString2ParametersNegSecond() {
		new CountDownTimer("2:-80");
	}

	@Test(expected = IllegalArgumentException.class)
	public void testConstructorString2ParametersAlpha() {
		new CountDownTimer("1:a");
	}
	...
	@Test(expected = IllegalArgumentException.class)
	public void testConstructorString1ParameterLargeSecond() {
		new CountDownTimer("80");
	}

	@Test(expected = IllegalArgumentException.class)
	public void testConstructorString1ParameterNegSecond() {
		new CountDownTimer("-80");
	}
	...
	public void testSub1() {
		CountDownTimer s = new CountDownTimer(0, 0, 2);
	...
	public void testSub10() {
		CountDownTimer s = new CountDownTimer(0, 0, 20);
	...
	public void testSub59() {
		CountDownTimer s = new CountDownTimer(0, 1, 58);
	...
	public void testSub60() {
		CountDownTimer s = new CountDownTimer(0, 2, 0);
	...
	@Test(expected = IllegalArgumentException.class)
	public void testSubOtherTimerLarge() {
		CountDownTimer s1 = new CountDownTimer(1, 2, 3);
		CountDownTimer s2 = new CountDownTimer(6, 5, 4);
		s1.sub(s2);
	}
